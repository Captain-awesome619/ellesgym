export const EXERCISE_GUIDES = [
  {
    ...
    musclesWorked: [
      {
        group: "Chest",
        parts: ["Upper Chest", "Middle Chest"],
      },
      {
        group: "Triceps",
    ...
    commonMistakes: [
      ...
      "Not lowering enough for full range of motion",
...

  {
    ...
    musclesWorked: [
      {
        group: "Back",
        parts: ["Lower Back", "Lats", "Traps"],
      },
      {
        group: "Legs",
        parts: ["Hamstrings", "Quadriceps"],
      },
      {
        group: "Glutes",
        parts: ["Gluteus Maximus"],
      },
      {
        group: "Core",
        parts: ["Abs", "Lower Core"],
      },
    ],
    howToPerform:
...

  {
    ...
    musclesWorked: [
      {
        group: "Core",
        parts: ["Abs", "Transverse Abdominis", "Obliques"],
      },
      {
        group: "Shoulders",
        parts: ["Front Deltoids"],
    ...
    commonMistakes: [
      ...
      "Holding the breath",
      "Looking upward and straining the neck",
    ],
  },

  {
    ...
    musclesWorked: [
      {
        group: "Back",
        parts: ["Lats", "Upper Back"],
      },
      {
        group: "Biceps",
        parts: ["Short Head", "Long Head"],
      },
      {
        group: "Forearms",
        parts: ["Grip Muscles"],
    ...
    commonMistakes: [
      ...
      "Relying only on the arms instead of engaging the back",
    ],
  },

  {
    ...
    musclesWorked: [
      {
        group: "Chest",
        parts: ["Middle Chest", "Lower Chest"],
      },
      {
        group: "Triceps",
        parts: ["Long Head", "Medial Head"],
      },
      {
        group: "Shoulders",
        parts: ["Front Deltoids"],
